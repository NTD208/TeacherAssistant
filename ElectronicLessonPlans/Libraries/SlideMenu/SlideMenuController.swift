...
public struct SlideMenuOptions {
    public static var leftViewWidth: CGFloat = UIScreen.main.bounds.width/3 * 2
...
extension UIViewController {
    ...
    public func addLeftBarButtonWithImage(_ buttonImage: UIImage) {
        let leftButton: UIBarButtonItem = UIBarButtonItem(image: buttonImage, style: UIBarButtonItem.Style.done, target: self, action: #selector(self.toggleLeft))
        navigationItem.leftBarButtonItem = leftButton
    }
    
    public func addRightBarButtonWithImage(_ buttonImage: UIImage) {
        let rightButton: UIBarButtonItem = UIBarButtonItem(image: buttonImage, style: UIBarButtonItem.Style.done, target: self, action: #selector(self.toggleRight))
